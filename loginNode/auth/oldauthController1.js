...
const Admin = require('./zolduserModal1');
const Student = require('./zolduserModal1');
const Teacher = require('./zolduserModal1');
const HOD = require('./zolduserModal1');
...
//Profile  http://localhost:4000/api/auth/adminInfo
