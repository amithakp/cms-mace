                            ...
                            <div className=" col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <Link to ="/teacherTimeTable" className="btn btn-primary">Click</Link>
                                    </div>
                                </div>
                            </div>
                            <div className=" col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <div className=" col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <a href ="https://ktu.edu.in/home.htm;jsessionid=564C9D57428BB814DA4E81A691C6FAD6" className="btn btn-primary" target="_blank" rel="noreferrer">Click</a>
                                    </div>
                                </div>
                            </div>
                        </div>
